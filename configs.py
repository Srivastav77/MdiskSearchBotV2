...
class Config(object):
    API_ID = int(os.getenv("API_ID", "23774605"))
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001876494579")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Alpha1:alpha12345@cluster0.bucuitm.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001819650366"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "vegamovieio")
    FORCE_SUB = os.getenv("FORCE_SUB", "False")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 180))
    SHORTURLLINK.IN_API = os.getenv("SHORTURLLINK.IN_API", "0396fbbb425e3bfb82fcad84f27b6b1904337a54")
